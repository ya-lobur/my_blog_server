...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, '../my_blog_client')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Celery
BROKER_URL = 'redis://' + ENV_CONFIG['REDIS_HOST'] + ':' + ENV_CONFIG['REDIS_PORT'] + '/0'
BROKER_TRANSPORT_OPTIONS = {'visibility_timeout': 3600}
CELERY_RESULT_BACKEND = 'redis://' + ENV_CONFIG['REDIS_HOST'] + ':' + ENV_CONFIG['REDIS_PORT'] + '/0'
